...
const Landing = () => {
  return (
    <div>
      ...
      <div className='Marquee' style={{backgroundColor:'#34788d',padding:'2px',display:'grid', gridTemplateColumns:'repeat(7)'}}>
        <p style={{gridColumnStart:'1',gridColumnEnd:'8', fontSize:'20px',color:'white',marginTop:'10px'}}>Notices</p>
        <div style={{gridColumnStart:'1',gridColumnEnd:'1'}}><button className="stop_marquee" onClick={ e =>document.getElementById('mymarquee').stop()}><PauseIcon/></button></div>
        ...
        <div style={{gridColumnStart:'7',gridColumnEnd:'7'}}><button className="start_marquee" onClick={ e =>document.getElementById('mymarquee').start()}><PlayArrowIcon/></button></div>
      </div>
      <Landing_Dept/>
      <Landing_Cont/>
      <Landing_Notices/>
